...
num_of_atom_new = 3176;

filename='afterrot2_vasp.xyz'; %the input should be comming from shanshan's code
...
filename2 = 'unitcell2_rec.vasp';
fid=fopen(filename2,'w');
fprintf(fid,'2.87_rotated_graphene\n')
fprintf(fid,'1.0\n')
