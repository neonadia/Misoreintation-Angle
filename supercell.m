...
base1 = [49.16274642,0,0];  % need to adjust according to the lattice vector in the origin file
base2 = [0,85.1523742676,0];

new_base1 = base1 * sup_x; % supercell
new_base2 = base2 * sup_z;
new_base3 = [0,0,6.9543900490];

filename='unitcell2_rec_fine'; %the input should be comming from shanshan's code
...
filename2 = 'AB2-2-50.vasp';
fid2=fopen(filename2,'w')
fprintf(fid2,'2.87_rotated_graphene\n')
fprintf(fid2,'1.0\n')
...
filename3 = 'data.AB2-2-50';
fid3=fopen(filename3,'w')
fprintf(fid3,'# 2.87 Twisted Bilayer Graphene cell with dimension 2 x 50 x 1\n')
